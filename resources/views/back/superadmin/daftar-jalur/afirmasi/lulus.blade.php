...
<head>
    ...
    <title>Daftar Afirmasi Lulus</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h3 style="background-color: rgb(30, 161, 179); color: white; padding: 5px;">Daftar Siswa Jalur Afirmasi (Lulus)</h3>
        <table class="data-table" border="1">
            ...
            <tbody>
                @foreach ($afirmasis as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
