...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-sm-6 col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index_super_admin') }}"><i class="iconly-Home icli svg-color"></i></a></li>
        ...
        <div class="col-xl-4 proorder-xxl-1 col-sm-6 box-col-6">
            <div class="card welcome-banner">
                <div class="card-header p-0 card-no-border">
                    <div class="welcome-card"><img class="w-100 img-fluid" src="{{ asset('back/assets/images/dashboard-1/welcome-bg.png') }}" alt="" /><img class="position-absolute img-1 img-fluid" src="{{ asset('back/assets/images/dashboard-1/img-1.png') }}" alt="" /><img class="position-absolute img-2 img-fluid" src="{{ asset('back/assets/images/dashboard-1/img-2.png') }}" alt="" /><img class="position-absolute img-3 img-fluid" src="{{ asset('back/assets/images/dashboard-1/img-3.png') }}" alt="" /><img class="position-absolute img-4 img-fluid" src="{{ asset('back/assets/images/dashboard-1/img-4.png') }}" alt="" /><img class="position-absolute img-5 img-fluid" src="{{ asset('back/assets/images/dashboard-1/img-5.png') }}" alt="" /></div>
                </div>
                <div class="card-body">
                    <div class="d-flex align-center">
                        <h1>Hello, {{ auth()->user()->name }} <img src="{{ asset('back/assets/images/dashboard-1/hand.png') }}" alt="" /></h1>
                    </div>
                        ...
                        <table class="table display" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $terbaruPrestasi ? $terbaruPrestasi->user->name : 'N/A' }}</td>
                                    <td>{{ $terbaruPrestasi ? $terbaruPrestasi->user->sekolah->nama_sekolah : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <td><span class="badge bg-success">Jalur Afirmasi</span></td>
                                    <td>{{ $terbaruAfirmasi ? $terbaruAfirmasi->user->name : 'N/A' }}</td>
                                    <td>{{ $terbaruAfirmasi ? $terbaruAfirmasi->user->sekolah->nama_sekolah : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <td><span class="badge bg-danger">Jalur Domisili</span></td>
                                    <td>{{ $terbaruDomisili ? $terbaruDomisili->user->name : 'N/A' }}</td>
                                    <td>{{ $terbaruDomisili ? $terbaruDomisili->user->sekolah->nama_sekolah : 'N/A' }}</td>
                                </tr>
                            </tbody>
