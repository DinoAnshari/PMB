...
@section('title', 'Broadcast Prestasi - PPDB SMPN Maju Jaya')
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Kirim Pesan Broadcast ke Siswa Prestasi yang Lulus</h5>
                <button type="button"
                    class="btn btn-primary sweet-broadcast"
                    data-url="{{ route('broadcast.{jalur}.{status}.kirim', ['jalur' => 'prestasi', 'status' => 'Lulus']) }}"
                    data-title="Kirim Pesan Broadcast?"
                    data-text="Yakin ingin broadcast ke semua siswa prestasi yang lulus?">
