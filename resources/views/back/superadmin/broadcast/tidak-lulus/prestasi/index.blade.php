...
@section('title', 'Broadcast Prestasi (Tidak Lulus) - PPDB SMPN Maju Jaya')
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Broadcast Prestasi</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Kirim Pesan Broadcast ke Siswa Prestasi yang Tidak Lulus</h5>
                <button type="button"
                    class="btn btn-danger sweet-broadcast"
                    data-url="{{ route('broadcast.{jalur}.{status}.kirim', ['jalur' => 'prestasi', 'status' => 'tidak-lulus']) }}"
                    data-title="Kirim Pesan Broadcast?"
                    data-text="Yakin ingin broadcast ke semua siswa prestasi yang tidak lulus?">
