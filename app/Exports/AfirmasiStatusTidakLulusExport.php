...
class AfirmasiStatusTidakLulusExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    protected $affirmationTracks;

    public function __construct($affirmationTracks)
    {
        $this->affirmationTracks = $affirmationTracks;
    }

    public function collection()
    {
        return $this->affirmationTracks->map(function ($item) {
            return [
                'Nama' => $item->user->name ?? '-',
