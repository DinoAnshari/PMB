...
class DomisiliStatusTidakLulusExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    protected $domicileTracks;

    public function __construct($domicileTracks)
    {
        $this->domicileTracks = $domicileTracks;
    }

    public function collection()
    {
        return $this->domicileTracks->map(function ($item) {
            return [
                'Nama' => $item->user->name ?? '-',
